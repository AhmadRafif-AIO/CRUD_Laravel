...
<div class="row mt-5 mb-5">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="float-right">
            <a class="btn btn-success" href="<?php echo e(route('sisw.create')); ?>"> Input Siswa</a>
        </div>
    </div>
</div>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\applicationlaravel\crudlaravel\resources\views/sisw/index.blade.php ENDPATH**/ ?>